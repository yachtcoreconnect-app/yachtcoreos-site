...
3. Confirm the package filename is `YachtCrewCalculatorPack-v1.0.zip`.
4. Verify its SHA-256 checksum is:

   `2c7ecdb7716faee2c9c207bb4cfb5c0492d530ff228e831ed59cea5bf921eb99`
...
4. Attach `YachtCrewCalculatorPack-v1.0.zip`.
